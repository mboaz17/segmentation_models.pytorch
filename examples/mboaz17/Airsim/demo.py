...
x_test_dir = os.path.join(DATA_DIR, '../../data/Alta/train')
y_test_dir = os.path.join(DATA_DIR, '../../data/Alta/trainannot')
...
from examples.mboaz17.Alta.datasets import Dataset as DatadetAlta
